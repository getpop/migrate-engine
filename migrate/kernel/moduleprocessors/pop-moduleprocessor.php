...
use PoP\Engine\Facades\ModulePathManagerFacade;
...
abstract class ModuleProcessorBase
{
    ...
    // PUBLIC Functions
    //-------------------------------------------------
    abstract public function getModulesToProcess();
    ...
    final public function getAllSubmodules(array $module)
    {
    ...
    public function getModelPropsForDescendantModules(array $module, array &$props)
    {
        $ret = array();
        ...
        if ($dataloader_class) {
            ...
            foreach ($this->getDomainSwitchingSubmodules($module) as $subcomponent_data_field => $subcomponent_dataloader_options) {
                foreach ($subcomponent_dataloader_options as $subcomponent_dataloader_class => $subcomponent_modules) {
                    // If the subcomponent dataloader is not explicitly set in `getDomainSwitchingSubmodules`, then retrieve it now from the current dataloader's fieldValueResolver
    ...
    public function getRequestPropsForDescendantModules(array $module, array &$props)
    {
        return array();
    }

    public function getRequestPropsForDescendantDatasetmodules(array $module, array &$props)
    {
        return array();
    }
    ...
    protected function getPropGroup(string $group, array $module, array &$props, array $starting_from_modulepath = array())
    {
        if (!$props) {
            return array();
        }
    ...
    public function getDatabaseKeys(array $module, array &$props)
    {
        $ret = array();
            ...
            foreach ($subcomponents as $subcomponent_data_field => $subcomponent_dataloader_options) {
                ...
                foreach ($subcomponent_dataloader_classs as $subcomponent_dataloader_class) {
                    ...
                    if ($subcomponent_dataloader_class) {
                        ...
                        $ret[$subcomponent_data_field] = $subcomponent_dataloader->getDatabaseKey();
                    }
                }
            }
        }
    ...
    public function getImmutableSettingsDatasetmoduletree(array $module, array &$props)
    {
        $options = array(
    ...
    public function getImmutableDatasetsettings(array $module, array &$props)
    {
        $ret = array();
    ...
    protected function hasNoDataloader(array $module)
    {
        $moduleprocessor_manager = ModuleProcessorManagerFactory::getInstance();
    ...
    protected function addToDatasetDatabaseKeys(array $module, array &$props, $path, &$ret)
    {
        ...
        foreach ($this->getDomainSwitchingSubmodules($module) as $subcomponent_data_field => $subcomponent_dataloader_options) {
            foreach ($subcomponent_dataloader_options as $subcomponent_dataloader_class => $subcomponent_modules) {
                ...
                foreach ($subcomponent_modules as $subcomponent_module) {
                    $moduleprocessor_manager->getProcessor($subcomponent_module)->addToDatasetDatabaseKeys($subcomponent_module, $props[$moduleFullName][POP_PROPS_SUBMODULES], array_merge($path, [$subcomponent_data_field]), $ret);
                }
            }
        }
    ...
    public function getDatasetDatabaseKeys(array $module, array &$props)
    {
        $ret = array();
    ...
    public function getDatasource(array $module, array &$props)
    {
    ...
    public function getActionexecuterClass(array $module)
    {
        return null;
    }
    ...
    public function getImmutableDataPropertiesDatasetmoduletree(array $module, array &$props)
    {
    ...
    public function getImmutableDataPropertiesDatasetmoduletreeFullsection(array $module, array &$props)
    {
        $ret = array();
    ...
    public function getDatasetmoduletreeSectionFlattenedDataFields(array $module, array &$props)
    {
        $ret = array();
    ...
    public function getDatasetmoduletreeSectionFlattenedModules(array $module, $includeHeadModule = false)
    {
        $ret = [];
    ...
    public function isLazyload(array $module, array &$props)
    {
    ...
    public function getMutableonmodelDataPropertiesDatasetmoduletree(array $module, array &$props)
    {
    ...
    public function getMutableonmodelDataPropertiesDatasetmoduletreeFullsection(array $module, array &$props)
    {
        $ret = array();
    ...
    public function getMutableonrequestDataPropertiesDatasetmoduletree(array $module, array &$props)
    {
    ...
    public function getMutableonrequestDataPropertiesDatasetmoduletreeFullsection(array $module, array &$props)
    {
        $ret = array();
    ...
    public function getDataFeedbackDatasetmoduletree(array $module, array &$props, array $data_properties, $dataaccess_checkpoint_validation, $actionexecution_checkpoint_validation, $executed, $dbobjectids)
    {
    ...
    public function getDataFeedbackModuletree(array $module, array &$props, array $data_properties, $dataaccess_checkpoint_validation, $actionexecution_checkpoint_validation, $executed, $dbobjectids)
    {
        $ret = array();
    ...
    public function getDataFeedback(array $module, array &$props, array $data_properties, $dataaccess_checkpoint_validation, $actionexecution_checkpoint_validation, $executed, $dbobjectids)
    {
        return array();
    }

    public function getDataFeedbackInterreferencedModulepath(array $module, array &$props)
    {
        return null;
    }
    ...
    public function getBackgroundurlsMergeddatasetmoduletree(array $module, array &$props, array $data_properties, $dataaccess_checkpoint_validation, $actionexecution_checkpoint_validation, $executed, $dbobjectids)
    {
    ...
    public function getBackgroundurls(array $module, array &$props, array $data_properties, $dataaccess_checkpoint_validation, $actionexecution_checkpoint_validation, $executed, $dbobjectids)
    {
        return array();
    }
    ...
    public function getRelevantRoute(array $module, array &$props)
    {
        return null;
    }

    public function getRelevantRouteCheckpointTarget(array $module, array &$props)
    {
    ...
    public function getDataaccessCheckpoints(array $module, array &$props)
    {
    ...
    public function getActionexecutionCheckpoints(array $module, array &$props)
    {
        if ($route = $this->getRelevantRoute($module, $props)) {
    ...
    public function getDataloadSource(array $module, array &$props)
    {
        ...
        $ret = $cmsenginehelpers->addQueryArgs([
            ModuleFilterManager::URLPARAM_MODULEFILTER => \PoP\Engine\ModuleFilters\ModulePaths::NAME,
    ...
    public function getDataloadMultidomainSources(array $module, array &$props)
    {
    ...
    public function getDataloadMultidomainQuerySources(array $module, array &$props)
    {
        if ($sources = $this->getDataloadMultidomainSources($module, $props)) {
            ...
            if (\PoP\Engine\Server\Utils::externalSitesRunSameSoftware()) {
                ...
                // $cmsenginehelpers = \PoP\Engine\HelperAPIFactory::getInstance();
                // return array_map(
                //     function ($source) use ($module, $cmsenginehelpers) {
                //         return $cmsenginehelpers->addQueryArgs([
                //             \PoP\Engine\Managers\ModuleFilterManager::URLPARAM_MODULEFILTER => \PoP\Engine\ModuleFilters\HeadModule::NAME,
                //             \PoP\Engine\ModuleFilters\HeadModule::URLPARAM_HEADMODULE => $module,
                //         ], $source);
                //     },
                //     $sources
                // );
    ...
    public function queriesExternalDomain(array $module, array &$props)
    {
        if ($sources = $this->getDataloadMultidomainSources($module, $props)) {
    ...
    public function isMultidomain(array $module, array &$props)
    {
        if (!$this->queriesExternalDomain($module, $props)) {
            return false;
        }
    ...
    public function getModulesToPropagateDataProperties(array $module)
    {
        return $this->getSubmodulesByGroup($module, array(POP_MODULECOMPONENT_SUBMODULES));
    }
        ...
        foreach ($this->getDomainSwitchingSubmodules($module) as $subcomponent_data_field => $subcomponent_dataloader_options) {
            foreach ($subcomponent_dataloader_options as $subcomponent_dataloader_class => $subcomponent_modules) {
                ...
                if ($subcomponent_modules_data_properties['data-fields']) {
                    ...
                    $ret['subcomponents'][$subcomponent_data_field][$subcomponent_dataloader_class]['data-fields'] = $ret['subcomponents'][$subcomponent_data_field][$subcomponent_dataloader_class]['data-fields'] ?? array();
                    $ret['subcomponents'][$subcomponent_data_field][$subcomponent_dataloader_class]['data-fields'] = array_unique(
                        array_merge(
    ...
    public function getModelSupplementaryDbobjectdataModuletree(array $module, array &$props)
    {
        return $this->executeOnSelfAndMergeWithModules('getModelSupplementaryDbobjectdata', __FUNCTION__, $module, $props);
    }

    public function getModelSupplementaryDbobjectdata(array $module, array &$props)
    {
        return array();
    }
    ...
    public function getMutableonrequestSupplementaryDbobjectdataModuletree(array $module, array &$props)
    {
        return $this->executeOnSelfAndMergeWithModules('getMutableonrequestSupplementaryDbobjectdata', __FUNCTION__, $module, $props);
    }

    public function getMutableonrequestSupplementaryDbobjectdata(array $module, array &$props)
    {
        return array();
    }

    final private function getSubmodulesByGroup(array $module, $components = array())
    {
        $moduleprocessor_manager = ModuleProcessorManagerFactory::getInstance();
