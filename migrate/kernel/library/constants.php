...
const POP_CONSTANT_FIELDARGS_START = '(';
const POP_CONSTANT_FIELDARGS_END = ')';
const POP_CONSTANT_FIELDARGS_ATTSEPARATOR = ';';
const POP_CONSTANT_FIELDARGS_ATTKEYVALUESEPARATOR = ':';
const POP_CONSTANT_FIELDARGS_ATTVARIABLEPREFIX = '$';
