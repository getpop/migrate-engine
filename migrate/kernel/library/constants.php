...
define('POP_CONSTANT_UNIQUE_ID', \PoP\Engine\GeneralUtils::generateRandomString());
...
const POP_CONSTANT_PARAMFIELD_SEPARATOR = '|';
const POP_CONSTANT_DOTSYNTAX_DOT = '.';
const POP_CONSTANT_DOTSYNTAX_ALIASPREFIX = '[';
const POP_CONSTANT_DOTSYNTAX_ALIASSUFFIX = ']';
const POP_CONSTANT_SUBCOMPONENTDATALOADER_DEFAULTFROMFIELD = '*';

// Field Atts separator characters
const POP_CONSTANT_FIELDATTS_START = '(';
const POP_CONSTANT_FIELDATTS_END = ')';
const POP_CONSTANT_FIELDATTS_ATTSEPARATOR = ';';
const POP_CONSTANT_FIELDATTS_ATTKEYVALUESEPARATOR = ':';
const POP_CONSTANT_FIELDATTS_ATTVARIABLEPREFIX = '$';
